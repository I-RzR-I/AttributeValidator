...
//  ***********************************************************************
//  <copyright file="ValStartsWithAttribute.cs" company="RzR SOFT & TECH">
...
namespace RzR.Validation.Attributes.Attributes.String
{
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    ///     Attribute that validates a string begins with the specified prefix.
    /// </summary>
    /// <seealso cref="T:System.ComponentModel.DataAnnotations.ValidationAttribute" />
    /// =================================================================================================
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Field | AttributeTargets.Parameter)]
    public class ValStartsWithAttribute : ValidationAttribute
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     (Immutable) the required prefix.
        /// </summary>
        /// =================================================================================================
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     Initializes a new instance of the <see cref="ValStartsWithAttribute" /> class.
        /// </summary>
        /// <param name="prefix">The prefix the value must start with.</param>
        ...
        /// =================================================================================================
        public ValStartsWithAttribute(string prefix, bool ignoreCase = false, string userMessage = null) : base(string.Empty)
        {
            _prefix = prefix;
        ...
        public override string FormatErrorMessage(string name)
            => string.IsNullOrEmpty(CustomUserMessage)
                ? string.Format(Message.DefaultErrorMessage_StartsWith, name, _prefix)
                : CustomUserMessage;
        ...
        private bool ValidateObject(object value)
        {
            ...
            if (s == null || _prefix == null) 
                return false;

            return s.StartsWith(_prefix, _ignoreCase
