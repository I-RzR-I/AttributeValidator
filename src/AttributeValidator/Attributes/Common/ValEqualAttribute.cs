...
//  ***********************************************************************
//  <copyright file="ValEqualAttribute.cs" company="RzR SOFT & TECH">
...
namespace RzR.Validation.Attributes.Attributes.Common
{
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    ///     Attribute for validating that a value equals a fixed comparand. Equality is value-aware:
    ///     numeric values of different widths (e.g. <c>int</c> vs <c>long</c>)
    ...
    public class ValEqualAttribute : ValidationAttribute
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     Initializes a new instance of the <see cref="ValEqualAttribute" /> class.
        /// </summary>
        /// <param name="comparand">The value that the validated member must equal.</param>
        /// <param name="userMessage">
        ///     (Optional) The custom user message returned when validation fails.
        /// </param>
        /// =================================================================================================
        public ValEqualAttribute(object comparand, string userMessage = null)
            : base(string.Empty)
        {
        ...
        public override string FormatErrorMessage(string name)
            => string.IsNullOrEmpty(CustomUserMessage)
                ? string.Format(Message.DefaultErrorMessage_Equal, name, _comparand)
                : CustomUserMessage;

        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     Validates the object described by value. Returns true when <paramref name="value" /> is
        ///     value-aware equal to the comparand.
        /// </summary>
        ...
        private bool ValidateObject(object value)
            => MemberHelper.Evaluate(value, ValOp.Equals, _comparand);
    }
}