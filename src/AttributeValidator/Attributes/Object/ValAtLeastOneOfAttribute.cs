...
//  ***********************************************************************
//  <copyright file="ValAtLeastOneOfAttribute.cs" company="RzR SOFT & TECH">
...
namespace RzR.Validation.Attributes.Attributes.Object
{
    /// -------------------------------------------------------------------------------------------------
    /// <summary>
    ///     Class-level attribute that validates at least one of the named properties is populated.
    ...
    public class ValAtLeastOneOfAttribute : ValidationAttribute
    {
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     (Immutable) the property names that form the group.
        /// </summary>
        /// =================================================================================================
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        ///     Initializes a new instance of the <see cref="ValAtLeastOneOfAttribute" /> class.
        /// </summary>
        /// <param name="propertyNames">
        ///     The names of the properties on the decorated class of which at least one must be
        ///     populated.
        /// </param>
        /// =================================================================================================
        public ValAtLeastOneOfAttribute(params string[] propertyNames) : base(string.Empty)
        ...
        private string Compose()
            => string.IsNullOrEmpty(ErrorMessage)
                ? string.Format(Message.DefaultErrorMessage_AtLeastOneOf, string.Join(", ", _propertyNames))
                : ErrorMessage;
    }
}