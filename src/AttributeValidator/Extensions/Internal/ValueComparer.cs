...
namespace RzR.Validation.Attributes.Extensions.Internal
{
    ...
    internal static class ValueComparer
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Returns false (result = 0) if either argument is null, the type is unsupported, or any
        ///     conversion fails (fail-closed). Uses InvariantCulture for all conversions. result &lt; 0
        ///     means value &lt; comparand; result == 0 means equal; result &gt; 0 means value &gt;
        ///     comparand.
        /// </remarks>
        /// <param name="value">The value to compare.</param>
        /// <param name="comparand">The value to compare against.</param>
        /// <param name="result">
        ///     [out] When this method returns true, contains the sign of the comparison: negative if
        ///     value is less than comparand, zero if equal, positive if greater. Set to 0 when the
        ///     method returns false.
        /// </param>
        /// <returns>
        ///     True if the comparison succeeded; false if either argument is null, the type is
