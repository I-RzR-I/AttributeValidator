...
namespace ModelAttributeValidationTests.Tests.NotNull
{
    ...
    public class ValidationNotNullTests
    {
        ...
        {
            var model = new NotNullModel { Id = 1, Code = "Code1", Name = "Name1", IsActive = true };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
        ...
        {
            var model = new NotNullModel { Code = "Code1", Name = "Name1", IsActive = true };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
        ...
        {
            var model = new NotNullModel { Id = 1, Code = "Code1", IsActive = true };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
