...
namespace ModelAttributeValidationTests.Tests.NotEmpty
{
    ...
    public class ValidationNotEmptyTests
    {
        ...
        {
            var model = new NotEmptyModel { GId = Guid.NewGuid(), Name = "Name", Code = "Code" };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
        ...
        {
            var model = new NotEmptyModel { GId = Guid.NewGuid(), Code = "Code" };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
        ...
        {
            var model = new NotEmptyModel { GId = Guid.NewGuid(), Code = "Code", Name = "" };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
        ...
        {
            var model = new NotEmptyModel { Id = 1, Code = "Code1", Name = "Name1", IsActive = true };
            var context = new ValidationContext(model, null, null);
            var validationResults = new List<ValidationResult>();
